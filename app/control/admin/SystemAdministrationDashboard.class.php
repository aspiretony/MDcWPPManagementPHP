...
class SystemAdministrationDashboard extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $indicator3->enableSection('main', ['title' => _t('Servers'),    'icon' => 'university', 'background' => 'purple', 'value' => SystemUnit::count()]);
            $indicator4->enableSection('main', ['title' => _t('Sessions And Numbers'), 'icon' => 'code',       'background' => 'green',  'value' => SystemProgram::count()]);
