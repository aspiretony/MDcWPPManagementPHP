...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        $this->messages = [];
        $this->messages['en'] = [];
        $this->messages['en'][] = 'Servers';
        $this->messages['en'][] = 'Sessions And Numbers';
        ...
        $this->messages['pt'] = [];
        $this->messages['pt'][] = 'Servidores';
        $this->messages['pt'][] = 'Sessões/Numeros';
        ...
        $this->messages['es'] = [];
        $this->messages['es'][] = 'EL Servidores';
        $this->messages['es'][] = 'Sessions e Nombre Numero';
